...
class Videollama3Qwen2Processor(ProcessorMixin):
    ...
    def _process_conversation_without_label(
        ...
        **kwargs,
        ...
        return prompt, self.process_text(prompt, image_inputs, **output_kwargs["text_kwargs"])
    ...
    def _process_conversation(
        ...
        **kwargs: Unpack[Videollama3Qwen2ProcessorKwargs],
        ...
        if return_labels:
            ...
            text, text_inputs = self._process_conversation_without_label(conversation, image_inputs, **kwargs)

        return (text, BatchFeature(data={**text_inputs, **image_inputs}))
